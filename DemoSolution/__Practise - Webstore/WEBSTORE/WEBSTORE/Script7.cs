...
namespace WEBSTORE
{
    ...
    /// </summary>
    [TestModule("59369c27-303b-4da8-b2a7-f032a1e47340", ModuleType.UserCode, 1)]
...
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Open Browser,Passed,Automation Step: 0,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Confirm page has loaded,Passed,Automation Step: 1,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Select Product,Passed,Automation Step: 2,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Click Order Product,Passed,Automation Step: 3,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
Report.Info("Started Executing Script7 : Confirm page has loaded");
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Confirm page has loaded,Passed,Automation Step: 4,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Email Address,Passed,Automation Step: 5,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Confirmed Email Address,Passed,Automation Step: 7,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Name,Passed,Automation Step: 8,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Address Line 1,Passed,Automation Step: 9,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Address Line 2,Passed,Automation Step: 10,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter County,Passed,Automation Step: 11,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Post Code,Passed,Automation Step: 12,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Country,Passed,Automation Step: 13,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Click Save Shipping,Passed,Automation Step: 14,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
Report.Info("Started Executing Script7 : Confirm page has loaded");
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Confirm page has loaded,Passed,Automation Step: 15,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Click Continue,Passed,Automation Step: 16,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
Report.Info("Started Executing Script7 : Confirm page has loaded");
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Confirm page has loaded,Passed,Automation Step: 17,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Card Type,Passed,Automation Step: 18,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Enter Card Number,Passed,Automation Step: 19,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Click Complete Purchase,Passed,Automation Step: 20,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
Report.Info("Started Executing Script7 : Confirm page has loaded");
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Confirm page has loaded,Passed,Automation Step: 21,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
...
// Results Format: Path Guid, Block Guid, Result (pass/fail), Result, Resolved Test Data, Execution time, Stack Trace, Exception, Notes, Image
File.AppendAllText(Environment.CurrentDirectory + "\\" + "WEBSTORE" + ".csv", "Test Cases 7,Click Home,Passed,Automation Step: 22,,2017-08-23T08:00:00+02:00" + Environment.NewLine);
